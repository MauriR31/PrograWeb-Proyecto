...
const ProductDetails = ({ productDetails }) => {
  ...
  const navigate = useNavigate(); // Debes colocar useNavigate aquí dentro del componente
  ...
  const addToCart = () => {
    console.log("ID del producto:", productDetails.idProducto);
    console.log("Cantidad:", quantity)
    navigate('/carrito', { state: { id: productDetails.idProducto, cantidad: quantity } });
    ...
    <div className="container mx-auto mt-20 max-w-screen-xl">
      ...
      <div className="flex justify-between">
        ...
        <section className="product-info" style={{ width: '500px', marginLeft: '10px', marginTop: '10px', padding: '0' }}>
          <div className="title" style={{ marginTop: '2rem', fontSize: '1.5rem', fontWeight: 'bold' }}>{productDetails.title}</div>
          <div className="details" style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'row' }}>
            ...
            <div className="series" style={{ fontSize: '1.125rem', marginLeft: '10px' }}>Serie: {productDetails.serie}</div>
          </div>
          <div className="mr-10" style={{ marginTop: '110px', marginRight: '0px', padding: '0' }}>
            <img src={productDetails.imageUrl} alt={productDetails.title} className="w-400 h-auto transition duration-300 transform hover:scale-110" style={{ width: '400px', height: 'auto' }} />
          </div>
        </section>
        ...
        <aside className="Resul pt-4 pb-4 pl-6 pr-6 relative bg-green-300" style={{ width: '300px', height: '400px', marginTop: '100px', marginLeft: '10px', marginRight: '10px' }}>
          ...
          <div className="receipt-header absolute top-0 right-0 w-32 h-8" style={{ marginRight: '55px', marginTop: '36px' }}>
            <h1 className="text-lg font-semibold" style={{ fontSize: '28px' }}>{productDetails.precio}</h1>
          </div> 
          ...
          <button onClick={addToCart} className="add-to-cart w-40 h-10 bg-green-500 text-white rounded-md border-none uppercase font-bold my-10 mx-12 transition duration-300 hover:bg-green-600" style={{ width: '200px', height: '40px', marginLeft: '32px', marginTop: '50px' }}>
            AÑADIR AL CARRITO
          </button>
      ...
      <article className="Carac bg-white shadow-md rounded-lg p-8 mt-8 mx-4" style={{ marginTop: '30px', marginBottom: '30px' }}>
        ...
        <ul className="list-disc list-inside">
          <li className="text-base mb-4 text-gray-800"><span className="font-semibold">Material:</span> {productDetails.material}</li>
          <li className="text-base mb-4 text-gray-800"><span className="font-semibold">Serie:</span> {productDetails.serie}</li>
