...
const PedidoCompleto = () => {
    return (
        ...
        <div className="w-full min-h-screen bg-gray-100">
            ...
            <section className="bg-white mb-0 pb-5" >
                <p className="text-2xl ml-5">También te podría interesar...</p>
            </section>
            <section className="flex flex-wrap gap-4 ml-5 flex justify-center bg-white w-full min-h-screen mt-0">
