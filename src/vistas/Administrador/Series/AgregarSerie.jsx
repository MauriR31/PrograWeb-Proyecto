              ...
              <div className="w-1000 p-4 flex">
                ...
                <div className='w-full m-5'>
                  ...
                  <div className='mb-5 '>
                    ...
                    <Link to="/Admin/series/AgregarSeries/AgregarProducto" className="bg-blue-500 text-white px-4 py-2 rounded-md mr-2">+</Link>
                  ...
                  <div className="w-1/2 p-4">
                    <button onClick={guardarCambios} className="bg-green-500 text-white px-4 py-2 rounded-md">Guardar</button>
                  </div>
                </div>
              </div>
            </section>
