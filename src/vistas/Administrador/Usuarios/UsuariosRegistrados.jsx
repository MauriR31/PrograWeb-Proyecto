...
import MenuOpcion from './BotonMenuOpciones';
    ...
    <>
      ...
      <div className="flex justify-center py-4" style={{ backgroundColor:'#EEEEEE' }}>
        ...
        <main className="flex flex-col max-w-6xl w-full">
          ...
          <section className="p-3.5 flex">
            <button className='block flex-none w-1/4'>
              Menu
            </button>
            <input
              type="text"
          ...
          <section id="MURAListado" className="px-3 text-sm">
            ...
            <div className='grid grid-cols-1 grid-rows-10'>
              {usuariosEnPagina.map(usuario => (
                <article key={usuario.id} className="flex bg-white py-2 px-4 hover:bg-slate-100 items-center mb-1 rounded-md">
                  ...
                  <p className="w-1/6">{usuario.fechaRegistro}</p>
                  <p className="w-1/12">{usuario.estado}</p>
                  {/* Columna de Acciones */}
                  <p className="w-1/12 grid">
                    <MenuOpcion className="place-self-center"
                      usuario={usuario}
